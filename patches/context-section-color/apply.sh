...
#
# Usage: ./patches/context-section-color/apply.sh
#
...
apply_one() {
    ...
    if grep -q "PATCHED by context-section-color" "$PACKAGE_ROOT/dist/modes/interactive/interactive-mode.js" 2>/dev/null; then
