...
- [!] Map `cwd-args.test.ts` to a separate Node parity target with the same eleven declared identities, fifteen runtime cases, and no normative change; local Node 22.19.0 passes while cross-platform evidence remains pending.
