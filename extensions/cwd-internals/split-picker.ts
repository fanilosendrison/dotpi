...
import { isSplitType } from "./args";
import type { CwdCommandContext, SplitType } from "./types";
...
export async function pickSplitType(ctx: CwdCommandContext): Promise<SplitType | null> {
	if (!ctx.ui.custom) {
